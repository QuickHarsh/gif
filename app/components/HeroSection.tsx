      ...
      <div className="container-custom py-20 relative">
        ...
        >
          <motion.div
            ...
            className="absolute top-20 right-20 w-12 h-12 text-primary-600 opacity-20"
          >
          ...
          <motion.div
            ...
            className="absolute bottom-40 left-20 w-12 h-12 text-primary-600 opacity-20"
          >
          ...
          <motion.div
            ...
            className="absolute top-40 left-1/3 w-12 h-12 text-primary-600 opacity-20"
          >
                ...
                {categories.map((item, index) => (
                  ...
                  >
                    <motion.div 
                      ...
                      className="h-32 flex items-center justify-center bg-gray-100 rounded-md mb-2"
                    >
                      <img 
                        src={item.image} 
                        alt={item.name} 
